...
> Подсказка: опции можно комбинировать. Например: `fuck-u-code analyze . -v -l ru` (подробный вывод на русском).
...
> Подсказка: опции можно комбинировать. Например: `fuck-u-code ai-review . -m gpt-4o -v -l ru`.
